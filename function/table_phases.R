...
table_phases <- function(phases, save_at = NULL) {
  ...
  # 
  # On regroupe le tout : 
  phases_features <- rbind(phases_asc_auc_tot, phases_asc_auc_mean, phases_asc_dur_tot, phases_asc_dur_mean, phases_asc_slope_e, 
                           phases_desc_auc_tot, phases_desc_auc_mean, phases_desc_dur_tot, phases_desc_dur_mean, phases_desc_slope_e, 
